...
[![MongoDB](https://img.shields.io/badge/MongoDB-Reactive%20Streams%201.13.0-blue.svg)](https://github.com/mongodb/mongo-java-driver-reactivestreams/releases/tag/r1.13.0)
[![#fluid-libraries Slack Channel](https://img.shields.io/badge/slack-%23fluid--libraries-543951.svg?label=Slack)](https://kotlinlang.slack.com/messages/C7UDFSVT2/)

Kotlin coroutine support for MongoDB built on top of the official [MongoDB Reactive Streams Java Driver](https://mongodb.github.io/mongo-java-driver-reactivestreams/1.13/).
...
```kotlin
dependencies {
    implementation("io.fluidsonic.mongo:fluid-mongo:1.0.0-beta.4")
}
```
